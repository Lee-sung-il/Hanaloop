...
'무거운 컴포넌트 라이브러리 사용 금지' 요구사항에 맞춰, shadcn/ui를 선택했습니다. 이는 프로젝트에 직접 추가하여 소유권을 갖고 커스터마이징할 수 있는 컴포넌트 모음이므로 요구사항에 부합한다고 판단했습니다.

사용자 경험 향상을 위해 next-themes를 사용하여 다크 모드 기능을 추가로 구현했습니다.
